        ...
        <template :key="bKey" v-for="[bKey, bConfig] in Object.entries(boards)">
            <div class="v-kaban-board" :class="{collapsed: !bConfig.expanded}">
                <div class="v-kaban-board-header">
                    <div class="v-kaban-header-left-bar">
...
.v-kaban-header-left-bar{
    margin-right: auto;
    display: flex;
}
.v-kaban-header-left-bar > div {
    /*margin-left: 9px;*/
    padding: 4px;
}

.collapsed .v-kaban-header-left-bar {
    /*white-space: nowrap;*/
    display: inline-block;
    flex-direction: column;
}
